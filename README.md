...
10. [Compilation and Execution Instructions](#compilation-and-execution-instructions)
11. [License](#license)
...
Make sure you are in the root directory of the project, which contains the Arc, csv, Report, and src folders.
...
- -o main: Specifies the output file name as main (or main.exe on Windows).
- src/main.c: The source file to compile.
...
- ./: Indicates that the file is located in the current directory.
- main (or main.exe): The executable file generated by the compilation process.